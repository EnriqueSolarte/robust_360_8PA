...
class Shi_Tomasi_Extractor():
    def __init__(self, cfg: Cfg):
        ...
        self.feature_params = dict(maxCorners=cfg.max_number_corners,
                                   qualityLevel=cfg.quality_corner_level,
                                   minDistance=cfg.min_corner_distance,
                                   blockSize=cfg.block_size_for_corners)
