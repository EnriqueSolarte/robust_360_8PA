...
def eval_camera_pose(tracker, cam_gt):
    ...
    kwargs["bearings"]["kf"] = kfrm
    kwargs["bearings"]["frm"] = frm
    ...
    print("8PA:         {}".format(evaluate_error_in_transformation(transform_gt=cam_gt,
                                         transform_est=cam_8p)))
    print("Opt_Res_SK:  {}".format(evaluate_error_in_transformation(transform_gt=cam_gt,
                                         transform_est=cam_opt_res_SK)))
    print("Opt_Res_Rt:  {}".format(evaluate_error_in_transformation(transform_gt=cam_gt,
                                                                    transform_est=cam_opt_res_Rt)))
    print("Opt_Res_SK_Rt:  {}".format(evaluate_error_in_transformation(transform_gt=cam_gt,
