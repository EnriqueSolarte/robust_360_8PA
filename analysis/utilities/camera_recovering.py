...
def res_error_S_K(
    ...
    residuals_1 = projected_distance(e=e_hat, x1=bearings_kf, x2=bearings_frm)

    residuals_2 = projected_distance(e=e_norm,
                                     x1=bearings_kf_norm,
                                     x2=bearings_frm_norm)
...
def rpj_S_K_const_lm(parameters, bearings_kf, bearings_frm, landmarks_kf):
    ...
    landmarks_kf_ = solver.triangulate_points_from_cam_pose(
        cam_pose=cam_hat, x1=bearings_kf.copy(), x2=bearings_frm.copy())
    ...
    residuals_2 = sampson_distance(e=e_norm,
                                   x1=bearings_kf_norm,
                                   x2=bearings_frm_norm)
