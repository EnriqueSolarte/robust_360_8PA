...
def eval_frame(**kwargs):
    ...
    for idx in kwargs["grid_range"]:
        ...
        kwargs["bearings"]["kf_norm"], t1 = normalizer_s_k(x=bearings_kf, s=s, k=k)
        kwargs["bearings"]["frm_norm"], t2 = normalizer_s_k(x=bearings_frm, s=s, k=k)
        ...
        print("{} : {}".format(kwargs["filename"], idx / kwargs["ss_grid"].size))
    return kwargs
...
if __name__ == '__main__':
    ...
    kwargs = eval_frame(**scene_settings,
                        **features_setting,
                        **ransac_parm
                        )
